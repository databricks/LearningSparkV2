...
This dataset is distrinbuted for public use at [Data.gov](https://catalog.data.gov/dataset?res_format=JSON&tags=population)

## LICENSE
This project utilizes code from https://wordpress.org/. Therefore, all code and content created by WordPress is licensed under the GNU General Public License. All contributions and code added to this project are dedicated to the public domain worldwide.
